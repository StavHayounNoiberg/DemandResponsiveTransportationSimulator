...
def run_simulation(simulation_id, line_id, start_time, end_time, express_rate, reporting_rate, simulation_start_time):
    ...
    try:
        ...
        if len(sys.argv) == 8:
            ...
            for i in range(iterations):
                ...
                thread = threading.Thread(target=run_simulation, name=thread_name, args=(iteration_id, line_id, start_time, end_time, express_rate, reporting_rate, simulation_start_time))
